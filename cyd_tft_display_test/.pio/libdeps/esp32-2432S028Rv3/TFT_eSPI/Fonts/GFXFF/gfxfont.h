...
#ifdef LOAD_GFXFF
#warning "compiled with LOAD_GFXFF"
...
typedef struct { // Data stored for FONT AS A WHOLE:
  ...
  #ifdef GFXFF_LOAD_FONTS
  #warning "compiled with GFXFF_LOAD_FONTS"
  ...
  #else
    #warning "compiled without GFXFF_LOAD_FONTS"
    #endif
#else 
  #warning "compiled without LOAD_GFXFF"
#endif // LOAD_GFXFF
